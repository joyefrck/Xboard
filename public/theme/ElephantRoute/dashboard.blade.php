...
<head>
  ...
  <link rel="stylesheet" href="/theme/{{$theme}}/assets/elephant-route-dashboard-v2.css?v={{$version}}-er20260918telegramBinding1">
...
<body>
  ...
  <script src="/theme/{{$theme}}/assets/elephant-route-dashboard-v2.js?v={{$version}}-er20260918telegramBinding1"></script>
