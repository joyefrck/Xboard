  ...
  "settings": {
    ...
    "telegram": {
      ...
      "group_access": {
        "title": "공식 그룹 가입 심사",
        "chat_id": "공식 그룹 ID",
        "description": "계정 연결 봇이 관리하는 비공개 그룹을 사용하세요. 유료 구매 및 관리자 제공 요금제의 가입 자격은 만료 후에도 유지됩니다.",
        "check": "그룹 설정 확인",
        "checking": "확인 중…",
        "ready": "기술 검사를 통과했습니다. 활성화 전 아래 수동 확인을 완료하세요.",
        "not_ready": "그룹 ID, 봇 권한 및 웹훅을 확인하세요.",
        "check_private": "비공개 그룹",
        "check_bot": "봇 승인 권한",
        "check_webhook": "가입 요청 웹훅",
        "pass": "통과",
        "fail": "미통과",
        "enable": "가입 심사 활성화",
        "prerequisites": "과거 자격을 검증하여 등록하고 기존 무심사 초대를 취소하며 일반 회원의 직접 초대를 제한하세요. 원본 그룹 링크는 사용자에게 제공되지 않습니다. 비활성화하면 신규 가입이 중지됩니다."
      },
      "discuss_link": {
        "title": "그룹 링크",
  ...
  "user": {
    ...
    "edit": {
      ...
      "form": {
        ...
        "traffic_package_add_gb_placeholder": "추가 트래픽을 입력하세요",
