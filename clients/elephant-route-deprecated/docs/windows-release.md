...
.\scripts\build_windows_release.ps1 -Version 1.6.9 -BuildNumber 10609
```
...
```powershell
Get-FileHash .\windows\installer\output\ElephantNetwork-Setup-x64-v1.6.9.exe -Algorithm SHA256
