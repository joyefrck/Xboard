...
class UserRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            $router->get('/invite/registrations', [InviteController::class, 'registrations']);
            // Notice
            ...
            $router->get('/ticket/attachment/{attachment}', [TicketController::class, 'attachment']);
            ...
            $router->get('/telegram/binding', [TelegramController::class, 'binding'])->middleware('throttle:30,1');
